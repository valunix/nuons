...
internal class CombinedServiceRegistrationSourceBuilder
{
	...
	public string Build(ImmutableArray<CombinedServiceRegistrationIncrement> registrations)
	{
		...
		var source = $@"namespace Nuons.DependencyInjection.Extensions;

public static class {className}
{{
	public static void AddDependancyInjectionServices(this global::Microsoft.Extensions.DependencyInjection.IServiceCollection services)
